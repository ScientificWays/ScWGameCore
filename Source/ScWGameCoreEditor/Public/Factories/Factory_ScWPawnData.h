...
#include "Factory_ScWPawnData.generated.h"

UCLASS()
class SCWGAMECOREEDITOR_API UFactory_ScWPawnData : public UFactory
{
    GENERATED_BODY()

public:
    UFactory_ScWPawnData(const FObjectInitializer& InObjectInitializer);
