...
#include "Factory_ScWExperience.generated.h"

UCLASS()
class SCWGAMECOREEDITOR_API UFactory_ScWExperience : public UFactory
{
    GENERATED_BODY()

public:
    UFactory_ScWExperience(const FObjectInitializer& InObjectInitializer);
