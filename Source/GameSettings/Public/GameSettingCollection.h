...
public:
	MODULE_API UGameSettingCollection();

	virtual TArray<UGameSetting*> GetChildSettings() override { return Settings; }
	MODULE_API TArray<UGameSettingCollection*> GetChildCollections() const;

	MODULE_API void AddSetting(UGameSetting* Setting);
	MODULE_API virtual void GetSettingsForFilter(const FGameSettingFilterState& FilterState, TArray<UGameSetting*>& InOutSettings) const;
...
public:
	MODULE_API UGameSettingCollectionPage();
	...
	MODULE_API virtual void GetSettingsForFilter(const FGameSettingFilterState& FilterState, TArray<UGameSetting*>& InOutSettings) const override;
	virtual bool IsSelectable() const override { return true; }

	/**  */
	MODULE_API void ExecuteNavigation();
