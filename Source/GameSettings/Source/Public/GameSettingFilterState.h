...
public:
	...
	MODULE_API FGameSettingFilterState();
...
public:
	MODULE_API void SetSearchText(const FString& InSearchText);

	MODULE_API bool DoesSettingPassFilter(const UGameSetting& InSetting) const;

	MODULE_API void AddSettingToRootList(UGameSetting* InSetting);
	MODULE_API void AddSettingToAllowList(UGameSetting* InSetting);
