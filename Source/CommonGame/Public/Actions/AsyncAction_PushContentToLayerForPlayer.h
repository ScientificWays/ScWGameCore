...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintCosmetic, meta = (DefaultToSelf = "InOwningPlayer", DisplayName = "Push Content to Layer for Player (Async)", BlueprintInternalUseOnly = "true"))
