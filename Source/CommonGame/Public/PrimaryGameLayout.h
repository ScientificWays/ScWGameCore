...
public:
	static MODULE_API UPrimaryGameLayout* GetPrimaryGameLayoutForPrimaryPlayer(const UObject* WorldContextObject);
	static MODULE_API UPrimaryGameLayout* GetPrimaryGameLayout(APlayerController* PlayerController);
