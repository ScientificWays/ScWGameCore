...
protected:
	...
	void ApplySetByCallerDamage(UScWAbilitySystemComponent* InTargetASC, float InDamageAmount);
	void ApplySetByCallerHeal(UScWAbilitySystemComponent* InTargetASC, float InHealAmount);
