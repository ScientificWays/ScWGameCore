...
#include "ScWAudioSettings.generated.h"
...
USTRUCT()
struct FScWSubmixEffectChainMap
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(Category = "MixSettings", config, EditAnywhere, meta = (AllowedClasses = "/Script/AudioModulation.SoundControlBusMix"))
	...
	/** The Default Base Control Bus Mix */
	UPROPERTY(Category = "UserMixSettings", config, EditAnywhere, meta = (AllowedClasses = "/Script/AudioModulation.SoundControlBusMix"))
	FSoftObjectPath UserSettingsControlBusMix;

	/** Control Bus assigned to the Overall sound volume setting */
	UPROPERTY(Category = "UserMixSettings", config, EditAnywhere, meta = (AllowedClasses = "/Script/AudioModulation.SoundControlBus"))
	...
	UPROPERTY(Category = "EffectSettings", config, EditAnywhere)
	TArray<FScWSubmixEffectChainMap> HDRAudioSubmixEffectChain;

	/** Submix Processing Chains to achieve low dynamic range audio output */
	UPROPERTY(Category = "EffectSettings", config, EditAnywhere)
	TArray<FScWSubmixEffectChainMap> LDRAudioSubmixEffectChain;
