...
#include "ScWGameFeaturesProjectPolicies.generated.h"
...
class UScWGameFeaturesProjectPolicies : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()
...
// checked
/*UCLASS()
class UScWGameFeature_HotfixManager : public UObject, public IGameFeatureStateChangeObserver
{
	GENERATED_BODY()
