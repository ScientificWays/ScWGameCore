...
public:
	...
	UPROPERTY(Category = "Default Gameplay Effects", EditDefaultsOnly, meta = (DisplayName = "Damage Gameplay Effect (SetByCaller)"))
	TSoftClassPtr<class UGameplayEffect> DamageGameplayEffect_SetByCaller;

	// Gameplay effect used to apply healing.  Uses SetByCaller for the healing magnitude.
	UPROPERTY(Category = "Default Gameplay Effects", EditDefaultsOnly, meta = (DisplayName = "Heal Gameplay Effect (SetByCaller)"))
	TSoftClassPtr<class UGameplayEffect> HealGameplayEffect_SetByCaller;

	// Gameplay effect used to add and remove dynamic tags.
	UPROPERTY(Category = "Default Gameplay Effects", EditDefaultsOnly)
