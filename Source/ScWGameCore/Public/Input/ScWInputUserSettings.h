...
#include "ScWInputUserSettings.generated.h"

#define MODULE_API SCWGAMECORE_API

/** 
 * Custom settings class for any input related settings for the ScW game.
 * This will be serialized out at the same time as the ScW Shared Settings and is
 * compatible with cloud saves through by calling the "Serialize" function.
 */
UCLASS(MinimalAPI)
class UScWInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
	//~ Begin UEnhancedInputUserSettings interface
	MODULE_API virtual void ApplySettings() override;
 ...
 */
UCLASS(MinimalAPI)
class UScWPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
...
public:
	...
	MODULE_API const FText& GetTooltipText() const;
