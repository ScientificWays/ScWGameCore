...
class UScWAimSensitivityData;
class UObject;

/** 
*  Scales input based on a double property in the SharedUserSettings
*/
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "[ScW] Setting Based Scalar"))
class UScWSettingBasedScalar : public UInputModifier
{
	GENERATED_BODY()
...
/**
 * This is a deadzone input modifier that will have it's thresholds driven by what is in the ScW Shared game settings. 
 */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "[ScW] Settings Driven Dead Zone"))
class UScWInputModifierDeadZone : public UInputModifier
{
	GENERATED_BODY()
...
UENUM()
enum class EScWTargetingType : uint8
{
	/** Sensitivity to be applied while normally looking around */
	Normal = 0,
...
/** Applies a scalar modifier based on the current gamepad settings in ScW Shared game settings.  */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "ScW Gamepad Sensitivity"))
class UScWInputModifierGamepadSensitivity : public UInputModifier
{
	GENERATED_BODY()
public:
...
/** Applies an inversion of axis values based on a setting in the ScW Shared game settings */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "ScW Aim Inversion Setting"))
class UScWInputModifierAimInversion : public UInputModifier
{
	GENERATED_BODY()
