...
#include "ScWPlayerInput.generated.h"

/**
 * Custom player input class for ScW. This extends the functionality of Enhanced Input to also include
...
class UScWPlayerInput : public UEnhancedPlayerInput
{
	GENERATED_BODY()

public:
	UScWPlayerInput();
	virtual ~UScWPlayerInput() override;
