...
#include "ScWPlatformEmulationSettings.generated.h"
...
class UScWPlatformEmulationSettings : public UDeveloperSettingsBackedByCVars
{
	GENERATED_BODY()

public:
	UScWPlatformEmulationSettings();
...
private:
	UPROPERTY(Category = "PlatformEmulation", EditAnywhere, Config, meta = (Categories="Input,Platform.Trait"))
	FGameplayTagContainer AdditionalPlatformTraitsToEnable;

	UPROPERTY(Category = "PlatformEmulation", EditAnywhere, Config, meta = (Categories="Input,Platform.Trait"))
	FGameplayTagContainer AdditionalPlatformTraitsToSuppress;

	UPROPERTY(Category = "PlatformEmulation", EditAnywhere, Config, meta = (GetOptions=GetKnownPlatformIds))
	...
	UPROPERTY(Category = "PlatformEmulation", EditAnywhere, Config, meta = (GetOptions=GetKnownDeviceProfiles, EditCondition=bApplyDeviceProfilesInPIE))
	...
	UPROPERTY(Category = "PlatformEmulation", EditAnywhere, Config, meta = (ConsoleVariable="ScW.Settings.ApplyFrameRateSettingsInPIE"))
	...
	UPROPERTY(Category = "PlatformEmulation", EditAnywhere, Config, meta = (ConsoleVariable="ScW.Settings.ApplyFrontEndPerformanceOptionsInPIE"))
	bool bApplyFrontEndPerformanceOptionsInPIE = false;

	// Should we apply experience/platform emulated device profiles in PIE?
	UPROPERTY(Category = "PlatformEmulation", EditAnywhere, Config, meta = (InlineEditConditionToggle, ConsoleVariable="ScW.Settings.ApplyDeviceProfilesInPIE"))
