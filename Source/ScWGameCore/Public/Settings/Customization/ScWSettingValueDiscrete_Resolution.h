...
#include "ScWSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class UScWSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UScWSettingValueDiscrete_Resolution();
