...
#include "ScWSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class UScWSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~UScWSettingValueDiscreteDynamic_AudioOutputDevice() = default;
