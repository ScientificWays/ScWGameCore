...
//#include "Settings/ScWMobilePerformance.h"
#include "GameSettingValueDiscrete.h"

#include "ScWSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class UScWSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UScWSettingValueDiscrete_MobileFPSType();
