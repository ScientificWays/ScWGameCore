...
/**
 *	Base class for costs that a ScWGameplayAbility has (e.g., ammo or charges)
 */
UCLASS(MinimalAPI, DefaultToInstanced, EditInlineNew, Abstract)
class UScWAbilityCost : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	virtual bool CheckCost(const UScWGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, FGameplayTagContainer* OptionalRelevantTags) const
	{
		return true;
	}
	 ...
	 */
	virtual void ApplyCost(const UScWGameplayAbility* Ability, const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo)
	{
	}
