...
namespace FScWCoreTags
{
	...
	// Pawn
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Pawn_Type_Player, "Pawn.Type.Player", "[Native] Should be used to mark pawn avatar as player's");
	...
	// Capability states
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(State_Dead, "State.Dead", "[Native] TODO: Add description");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(State_Dead_Started, "State.Dead.Started", "[Native] Owner is dead but not yet destroyed (most likely to be destroyed in the next tick).");
