...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ScWPlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "ScWCheats"

UScWPlatformEmulationSettings::UScWPlatformEmulationSettings()
{
}

FName UScWPlatformEmulationSettings::GetCategoryName() const
{
	return FApp::GetProjectName();
}

FName UScWPlatformEmulationSettings::GetPretendBaseDeviceProfile() const
{
	return PretendBaseDeviceProfile;
}

FName UScWPlatformEmulationSettings::GetPretendPlatformName() const
{
	return PretendPlatform;
}

#if WITH_EDITOR
void UScWPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UScWPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UScWPlatformEmulationSettings::PostInitProperties()
{
...
void UScWPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UScWPlatformEmulationSettings::ApplySettings()
{
...
void UScWPlatformEmulationSettings::ChangeActivePretendPlatform(FName NewPlatformName)
{
...
TArray<FName> UScWPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UScWPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UScWPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
