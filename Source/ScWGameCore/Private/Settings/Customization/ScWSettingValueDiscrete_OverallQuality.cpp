...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ScWSettingValueDiscrete_OverallQuality)

#define LOCTEXT_NAMESPACE "ScWSettings"

UScWSettingValueDiscrete_OverallQuality::UScWSettingValueDiscrete_OverallQuality()
{
}

void UScWSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();

	UScWSettingsLocal* UserSettings = UScWSettingsLocal::Get();
...
void UScWSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void UScWSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void UScWSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void UScWSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UScWSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> UScWSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 UScWSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 UScWSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
