...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ScWSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "ScWSettings"

UScWSettingValueDiscrete_Resolution::UScWSettingValueDiscrete_Resolution()
{
}

void UScWSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UScWSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void UScWSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void UScWSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void UScWSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UScWSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UScWSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UScWSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UScWSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UScWSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UScWSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UScWSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UScWSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UScWSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UScWSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UScWSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
