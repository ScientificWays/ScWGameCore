...
#include "Settings/Customization/ScWSettingValueDiscrete_Language.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ScWSettingValueDiscrete_Language)

#define LOCTEXT_NAMESPACE "ScW"

static const int32 SettingSystemDefaultLanguageIndex = 0;

UScWSettingValueDiscrete_Language::UScWSettingValueDiscrete_Language()
{
}

void UScWSettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void UScWSettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void UScWSettingValueDiscrete_Language::OnApply()
{
...
void UScWSettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void UScWSettingValueDiscrete_Language::RestoreToInitial()
{
	if (UScWSettingsShared* Settings = CastChecked<UScWLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void UScWSettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (UScWSettingsShared* Settings = CastChecked<UScWLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 UScWSettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const UScWSettingsShared* Settings = CastChecked<UScWLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> UScWSettingValueDiscrete_Language::GetDiscreteOptions() const
{
