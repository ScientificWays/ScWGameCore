...
static TAutoConsoleVariable<bool> CVarLatencyMarkersRequireNVIDIA(TEXT("ScW.Settings.LatencyMarkersRequireNVIDIA"),
	true,
...
public:
	...
	{
		if (!UScWSettingsLocal::DoesPlatformSupportLatencyTrackingStats())
		{
...
public:
	...
	virtual void GatherEditState(const ULocalPlayer * InLocalPlayer, FGameSettingEditableState & InOutEditState) const override
	{
		if (!UScWSettingsLocal::DoesPlatformSupportLatencyMarkers())
		{
			InOutEditState.Disable(LOCTEXT("PlatformDoesNotSupportLatencyMarkers", "Latency markers are not supported on this device"));
		}

		// ScW is only going to use the "Reflex" plugin to track these latency stats, so restrict these settings to NVIDIA devices. 
...
void UScWGameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, UScWLocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)EScWDisplayablePerformanceStat::Count == 18, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::ClientFPS);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::ServerFPS);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::FrameTime);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::IdleTime);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::Ping);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::PacketSize_Outgoing);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				...
				Setting->SetDefaultValue(UScWSettingsLocal::DoesPlatformSupportLatencyTrackingStats());
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::Latency_Total);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::Latency_Game);
			...
			{
				UScWSettingValueDiscrete_PerfStat* Setting = NewObject<UScWSettingValueDiscrete_PerfStat>();
				Setting->SetStat(EScWDisplayablePerformanceStat::Latency_Render);
