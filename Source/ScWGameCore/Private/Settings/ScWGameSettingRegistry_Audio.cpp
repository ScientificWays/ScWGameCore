...
UGameSettingCollection* UScWGameSettingRegistry::InitializeAudioSettings(UScWLocalPlayer* InLocalPlayer)
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UScWSettingsLocal>()->GetOverallVolume());
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UScWSettingsLocal>()->GetMusicVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UScWSettingsLocal>()->GetSoundFXVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UScWSettingsLocal>()->GetDialogueVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UScWSettingsLocal>()->GetVoiceChatVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
	...
	////////////////////////////////////////////////////////////////////////////////////
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			////////////////////////////////////////////////////////////////////////////////////
			{
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UScWSettingsShared>()->GetSubtitlesEnabled());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UScWSettingsShared>()->GetSubtitlesTextSize());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UScWSettingsShared>()->GetSubtitlesTextColor());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UScWSettingsShared>()->GetSubtitlesTextBorder());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UScWSettingsShared>()->GetSubtitlesBackgroundOpacity());
		...
		//----------------------------------------------------------------------------------
		{
			UScWSettingValueDiscreteDynamic_AudioOutputDevice* Setting = NewObject<UScWSettingValueDiscreteDynamic_AudioOutputDevice>();
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UScWSettingsShared>()->GetAllowAudioInBackgroundSetting());

			Setting->AddEnumOption(EScWAllowBackgroundAudioSetting::Off, LOCTEXT("EScWAllowBackgroundAudioSetting_Off", "Off"));
			Setting->AddEnumOption(EScWAllowBackgroundAudioSetting::AllSounds, LOCTEXT("EScWAllowBackgroundAudioSetting_AllSounds", "All Sounds"));
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UScWSettingsLocal>()->IsHeadphoneModeEnabled());

			Setting->AddEditCondition(MakeShared<FWhenCondition>(
				[](const ULocalPlayer*, FGameSettingEditableState& InOutEditState)
				{
					if (!GetDefault<UScWSettingsLocal>()->CanModifyHeadphoneModeEnabled())
					{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UScWSettingsLocal>()->IsHDRAudioModeEnabled());
