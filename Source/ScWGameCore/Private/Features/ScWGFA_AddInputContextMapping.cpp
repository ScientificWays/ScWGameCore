...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ScWGFA_AddInputContextMapping)

#define LOCTEXT_NAMESPACE "GameFeatures"

//////////////////////////////////////////////////////////////////////
// UScWGFA_AddInputContextMapping

void UScWGFA_AddInputContextMapping::OnGameFeatureRegistering()
{
...
void UScWGFA_AddInputContextMapping::OnGameFeatureActivating(FGameFeatureActivatingContext& Context)
{
...
void UScWGFA_AddInputContextMapping::OnGameFeatureDeactivating(FGameFeatureDeactivatingContext& Context)
{
...
void UScWGFA_AddInputContextMapping::OnGameFeatureUnregistering()
{
...
void UScWGFA_AddInputContextMapping::RegisterInputMappingContexts()
{
	RegisterInputContextMappingsForGameInstanceHandle = FWorldDelegates::OnStartGameInstance.AddUObject(this, &UScWGFA_AddInputContextMapping::RegisterInputContextMappingsForGameInstance);
...
void UScWGFA_AddInputContextMapping::RegisterInputContextMappingsForGameInstance(UGameInstance* GameInstance)
{
	if (GameInstance != nullptr && !GameInstance->OnLocalPlayerAddedEvent.IsBoundToObject(this))
	{
		GameInstance->OnLocalPlayerAddedEvent.AddUObject(this, &UScWGFA_AddInputContextMapping::RegisterInputMappingContextsForLocalPlayer);
		GameInstance->OnLocalPlayerRemovedEvent.AddUObject(this, &UScWGFA_AddInputContextMapping::UnregisterInputMappingContextsForLocalPlayer);
...
void UScWGFA_AddInputContextMapping::RegisterInputMappingContextsForLocalPlayer(ULocalPlayer* LocalPlayer)
{
...
void UScWGFA_AddInputContextMapping::UnregisterInputMappingContexts()
{
...
void UScWGFA_AddInputContextMapping::UnregisterInputContextMappingsForGameInstance(UGameInstance* GameInstance)
{
...
void UScWGFA_AddInputContextMapping::UnregisterInputMappingContextsForLocalPlayer(ULocalPlayer* LocalPlayer)
{
	if (ensure(LocalPlayer))
	{
		if (UEnhancedInputLocalPlayerSubsystem* EISubsystem = ULocalPlayer::GetSubsystem<UEnhancedInputLocalPlayerSubsystem>(LocalPlayer))
...
#if WITH_EDITOR
EDataValidationResult UScWGFA_AddInputContextMapping::IsDataValid(FDataValidationContext& Context) const
{
...
void UScWGFA_AddInputContextMapping::AddToWorld(const FWorldContext& WorldContext, const FGameFeatureStateChangeContext& ChangeContext)
{
...
void UScWGFA_AddInputContextMapping::Reset(FPerContextData& ActiveData)
{
...
void UScWGFA_AddInputContextMapping::HandleControllerExtension(AActor* Actor, FName EventName, FGameFeatureStateChangeContext ChangeContext)
{
...
void UScWGFA_AddInputContextMapping::AddInputMappingForPlayer(UPlayer* Player, FPerContextData& ActiveData)
{
...
void UScWGFA_AddInputContextMapping::RemoveInputMapping(APlayerController* PlayerController, FPerContextData& ActiveData)
{
