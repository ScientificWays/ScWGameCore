...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ScWExperienceDescription)

/*UCommonSession_HostSessionRequest* UScWExperienceDescription::CreateHostingRequest(const UObject* WorldContextObject) const
{
	...
	if (UScWReplaySubsystem::DoesPlatformSupportReplays())
	{
		if (bRecordReplay)
		{
