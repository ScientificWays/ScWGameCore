...
#include UE_INLINE_GENERATED_CPP_BY_NAME(ScWExperience)

#define LOCTEXT_NAMESPACE "ScWSystem"

UScWExperience::UScWExperience()
{
}

#if WITH_EDITOR
EDataValidationResult UScWExperience::IsDataValid(FDataValidationContext& Context) const
{
...
void UScWExperience::UpdateAssetBundleData()
{
