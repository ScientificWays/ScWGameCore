...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = Messaging, meta = (WorldContext = "WorldContextObject", BlueprintInternalUseOnly = "true", GameplayTagFilter = "GameplayMessage"))
	...
	MODULE_API virtual void SetReadyToDestroy() override;
